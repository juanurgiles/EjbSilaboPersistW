 ...
 */
@Stateless
@Path("com.utpl.javasilabopersist.entidad.requisitos")
public class RequisitosFacadeREST extends AbstractFacade<Requisitos> {
    @PersistenceContext(unitName = "EjbSilaboPersistWPU")
    private EntityManager em;

    public RequisitosFacadeREST() {
    ...
    @Override
    @Consumes({"application/xml", "application/json"})
    public void edit(Requisitos entity) {
        super.edit(entity);
    }
    ...
    public Requisitos find(@PathParam("id") Integer id) {
