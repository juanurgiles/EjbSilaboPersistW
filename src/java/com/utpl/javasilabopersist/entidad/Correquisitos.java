...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Correquisitos.findAll", query = "SELECT c FROM Correquisitos c"),
    @NamedQuery(name = "Correquisitos.findByIdRequisito", query = "SELECT c FROM Correquisitos c WHERE c.idRequisito = :idRequisito")})
